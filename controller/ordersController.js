...
/**
 * API
 * API Name : 주문 후 삭제 API
 */

const deleteOrder = async function (req, res) {
    const userId = req.user.id;

    const deleteOrder = await orderService.deleteCart(userId);
    return res.send(response(baseResponse.SUCCESS, '주문이 삭제 되었습니다.'));
};

module.exports = { orderInfo, addOrder, deleteOrder };